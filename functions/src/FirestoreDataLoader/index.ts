 ...
 * @param collectionPath The list of collection names.
 * @param docPath The list of document names.
 */
const checkValidDocumentPath = (
 ...
 * @param docPath The list of document names.
 */
const checkValidCollectionPath = (
  collectionPath: string[],
  docPath: string[]
): void => {
...
export class FirestoreDataLoader<DocumentModel extends DocumentData> {
   ...
   *
   * @param collectionPath The names of the Firestore collections.
   */
   ...
   * @param docPaths Paths (denoted by slashes) to the documents to be added.
   * @returns
   */
  async #batchLoad(
   ...
   *
   * @param docPath The names of the Firestore documents.
   *
...
// const yeet = new FirestoreDataLoader();
