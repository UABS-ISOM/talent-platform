...
export const addCourseMember: MutationResolvers['addCourseMember'] = async (
  _,
  { courseId, email, type },
  ...
  if ((await col.fetchDocById(courseId, newUser.uid)) !== undefined)
    throw new GraphQLError('This user is already a member of this course.', {
      extensions: {
        code: 'BAD_USER_INPUT',
      },
    });
